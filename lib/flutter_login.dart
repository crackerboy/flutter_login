...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      ...
      child: Scaffold(
        // Normally we want to use resizeToAvoidBottomInset for showing content
        // behind the keyboard, however this will obscure textfields, so we
        // use the primary color as background color to prevent a white
        // keyboard color.
